...
*Define Shock parameters (set equal to zero by default)
...
*Choose which shock to activate by setting the corresponding shock parameter equal to 1
*MDAshock = 1 ;
*FMPshock = 1 ;
*TFPshock = 1 ;

*Define Trade parameter (set equal to 1 for preferred specification)
parameter RoWtrade equal to 1 if Fish is traded RoW and zero if traded Local / 1 /
;

*Is Fish traded Locally? Activate next line
RoWtrade = 0 ;
