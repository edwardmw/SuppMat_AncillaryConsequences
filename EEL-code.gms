...
display xlqp, xlidsh, xlfshare, xlfshare_se,  xleshare, xlemin, xlendow, xlROCendow, xlROWendow,
     ...
     xlrevsh_rol, xlrevsh_row, xlwrkagepop;
...
*Make a subset of good for those goods that have a stock. This is only the fishing sector for now.
...
display g, f, h, fk, ft, ftv, ftw, gtv, gtw, gp, v, mapHv ;
...
* The next line of code ensures that "fish" is in the set of locally traded goods
gtv("fish")=yes ;

* The next line of code ensures that "fish" is NOT in the set of goods traded ROW
gtw("fish")=no ;
...
* choose the elasticity of supply of labor
$setglobal hlse 100
...
parameter MDAshock equal to 1 if simulating MDA shock;
MDAshock = 1 ;
...
*======================================================
*fixfac("fish","capital",h) = fixfac("fish","capital",h)*(1-25/100) ;
*FD.l("fish","capital",h) = fixfac("fish","capital",h) ;
...
*=====================================
*pshift("palmoil",h) = pshift("palmoil",h)*1.01 ;
